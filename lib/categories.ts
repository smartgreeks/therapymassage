...
export const CATEGORIES_EL: Record<string, Category> = {
  euexia: {
    ...
    sub: [
      { title: "Χαλαρωτικό μασάζ", desc: "Ήπιες πιέσεις και ρυθμικοί χειρισμοί για αποφόρτιση άγχους.", images: ["/images/services/relaxing.webp"], options: [
        { duration: "30'", price: "€17" },
        { duration: "45'", price: "€22" },
        { duration: "60'", price: "€27" },
        { duration: "90'", price: "€39" },
        { duration: "120'", price: "€50" },
      ] },
  ...
  omorfia: {
    ...
    hero: undefined,
    sub: [
      { title: "Φυσικό face lifting", desc: "Μη επεμβατικές τεχνικές τόνωσης και σύσφιξης.", images: ["/images/services/service19.webp"], duration: "30'", price: "€17" },
...
export const CATEGORIES_EN: Record<string, Category> = {
  ...
  omorfia: {
    ...
    hero: undefined,
    sub: [
      { title: "Natural face lifting", desc: "Non-invasive toning and tightening techniques.", images: ["/images/services/service19.webp"], duration: "30'", price: "€17" },
