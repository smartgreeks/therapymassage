    ...
    <main id="content" aria-labelledby="page-title">
      ...
      <section className="container-safe py-12 grid gap-8 lg:grid-cols-[2fr_1fr]">
        <article className="article-prose" itemScope itemType="https://schema.org/Article">
          ...
          <p>
            Στο Therapy Massage αξιολογούμε προσεκτικά τις ανάγκες και τις προτιμήσεις σας και σας προτείνουμε το καταλληλότερο είδος μασάζ.
          </p>

          <section aria-labelledby="intro">
            <h2 id="intro">Πώς επιλέγουμε μαζί</h2>
            <p>
              Συζητάμε σύντομα για την καθημερινότητά σας, τις εντάσεις που νιώθετε και τι θα θέλατε να πετύχετε από τη συνεδρία.
              Έτσι καταλήγουμε στην τεχνική που θα σας ωφελήσει περισσότερο τη δεδομένη στιγμή.
            </p>
          </section>

          <section aria-labelledby="how-we-choose">
            <h2 id="how-we-choose">Παράγοντες επιλογής</h2>
            <p>
              Λαμβάνουμε υπόψη το επίπεδο έντασης, τυχόν περιοχές με πόνο ή δυσκαμψία, την ποιότητα ύπνου, αλλά και το αν
              χρειάζεστε αποκατάσταση μετά από προπόνηση ή στοχευμένη θεραπευτική προσέγγιση.
            </p>
